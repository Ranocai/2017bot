...
void mainLoop(const Config& config) {
    ...
    while (!done) {
        ...
        //
        // Image 0 is a boiler image that was generated by another team.  It's already green-filtered,
        // so it should be simple (keyword "should") for PapasVision to find the critical pair of green
        // contours on the thing.
        int imageNumber = 9;
